            ...
            children: [
              ...
              Padding(
                ...
                child: GestureDetector(
                  onTap: (){},
                  child: Text("Mot de passe oublié?", style: TextStyle(color: Colors.lightBlue),),
                ),
              ),
              SizedBox(height: 40,),
              Column(
                  ...
                  Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text("Vous n'avez pas encore de compte?", style: TextStyle(color: Colors.white),),
                      ),
                      GestureDetector(
                        child: Text("Créer", style: TextStyle(color: Colors.lightBlue),),
                      ),
                    ],
                  ),
                  SizedBox(height: 20,),
                  Text("Ou se connecter via:", style: TextStyle(color: Colors.white),),
                  SizedBox(height: 15,),
