...
class _DashBoardScreenState extends State<DashBoardScreen> {
  ...
  Widget build(BuildContext context) {
    var val1 = context.watch<TotalAmountProvider>().cashOutAmountReceived;
    return Scaffold(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text('Total depensé'),
                  SizedBox(height: 10,),
                  Text('00\$', style: TextStyle(fontWeight: bold, fontSize: 20),),
                  SizedBox(height: 35,),
                  Text('Boutiques', style: TextStyle(fontWeight: bold),),
                  SizedBox(height: 10,),
