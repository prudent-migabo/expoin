...
class HashNumberProvider with ChangeNotifier{
  ...
  String hashETH = 'ICON (ETH)';
  String hashETC = 'ETHERIUM CLASSIC';
  ...
  String cashOutCryptoType = MesPiecesBloc.selectedCryptoName;
  void saveCashOutCryptoType (String newCryptoType){
    cashOutCryptoType = newCryptoType;
    notifyListeners();
  }

  String changeCryptoType = MesPiecesBloc.selectedCryptoName;
